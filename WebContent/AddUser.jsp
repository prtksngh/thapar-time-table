			...
			<form action="AddUser" method="post">
				<div class="form-group" style="background-color: #FFFFFF">
					...
					<label>Username</label> <input name="userid" type="text"
						class="form-control" placeholder="Username"></input> <label>Password</label>
					<input name="password" type="password" class="form-control"
						placeholder="Password"></input> <label>Teacher Id</label> <input
						name="tid" type="text" class="form-control"
						placeholder="TeacherId"></input> <br>
